	...
	const viewModel = ObservableModule.fromObject({
		...
		StartWalkthrough: function(args) {
			...
			setTimeout(()=>{
				...
				tip.show();
				console.log(this.isCheaterModeEnabled);
